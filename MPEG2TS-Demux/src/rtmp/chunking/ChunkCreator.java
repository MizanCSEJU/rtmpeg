...
public class ChunkCreator {
	/**
	 * Creates a chunk according to the 4 types that are defined in the
	 * standard.
	 * 
	 * @param chunkStreamID
	 * @param fmt
	 ...
	 */
	public static byte[] createChunk(int chunkStreamID, int fmt, int timestamp,
			int messageLength, byte messageType, int streamID)
		...
		case 0:
			...
			fillChunkHeader0(chunkMessageHeader, timestamp, messageLength,
					messageType, streamID);
			break;
		case 1:
		...
		System.arraycopy(chunkMessageHeader, 0, header, basicHeader.length,
				chunkMessageHeader.length);

		return header;
	}

	private static void fillChunkHeader2(byte[] chunkMessageHeader)
			throws UnsupportedFeature {
		// TODO Auto-generated method stub
		throw new UnsupportedFeature();
	}

	private static void fillChunkHeader1(byte[] chunkMessageHeader)
			throws UnsupportedFeature {
		// TODO Auto-generated method stub
		throw new UnsupportedFeature();
	}
	 ...
	 * @throws UnsupportedFeature
	 */
	private static void fillChunkHeader0(byte[] chunkMessageHeader,
			int timestamp, int length, byte messageType, int streamID)
			throws UnsupportedFeature {
